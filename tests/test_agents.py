...
class TestA2AProtocol:
    ...
    def test_message_creation(self):
        ...
        from src.a2a.protocol import create_request_message
        ...
        assert message["method"] == "search"

    def test_response_creation(self):
        """Test A2A response creation."""
        from src.a2a.protocol import create_request_message, create_response_message, StatusCode
        ...
        assert response["receiver"] == "planner"

    def test_parse_message(self):
        """Test message parsing."""
        from src.a2a.protocol import parse_message
        ...
        assert parsed["message_id"] == "test_123"
...
class TestA2AClient:
    ...
    async def test_client_initialization(self):
        ...
        client = A2AClient("http://localhost:8080/test", timeout=10)
        assert client is not None
        assert client.agent_endpoint == "http://localhost:8080/test"
